"""用 train_fixed_v6_0.6pkl_v19 改 v20
    1. 修改 containment_loss 讓人臉在image內
    2. 新增 grid_alignment_loss，原本的 alignment_loss只是單純向中心靠攏。
       加入一個「軸向對齊」邏輯，強迫元件的 x 座標或 y 座標對齊特定參考線(強化文字對齊損失)
    3. 在main()新增文字的長寬比讓排版更整齊
