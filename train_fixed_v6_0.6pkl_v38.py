"""用 train_fixed_v6_0.6pkl_v34 改 v38
    1. 元素長寬比固定、只等比縮放
    2. Image 如果固定，就固定 face
    3. whitespace style 隨機挑選
"""
import os
import argparse
import pickle
...
def main():
    ...
    print(torch.bincount(fixed_label[fixed_mask].view(-1).cpu(), minlength=6).tolist())
