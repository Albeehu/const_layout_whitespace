"""用 train_fixed_v6_0.6pkl_v57 改 v58
...
def _get_dynamic_region_cfg(template: str):
    ...
    cfg = {
        ...
        "frame_vertical": {
            "cx": 0.50, "cy": 0.50,
            "base_w": 0.12, "base_h": 0.12,
            "count_w": 0.030, "count_h": 0.030,
            "area_w": 0.28, "area_h": 0.28,
            "min_w": 0.16, "max_w": 0.34,
            "min_h": 0.16, "max_h": 0.46,
            "dir_w": 0.0, "dir_h": 0.0,
            "dir_margin": 0.00,
        },
        "right_column": {
        ...
        for data in train_dataloader:
            ...
            if iteration % 100 == 0:
                ...
                print(f'[{iteration}] Loss_D: {loss_D.item():.4f} Loss_G: {loss_G.item():.4f} '
                      f'STYLE:{curr_lambda_style:.3f} SPACE:{curr_lambda_space:.3f} FRAME:{loss_frame_balance.item():.3f} REGION:{loss_region.item():.3f} FG:{loss_fg_area.item():.3f} TXTW:{(curr_lambda_text_width * loss_text_width).item():.3f} '
