"""用 train_fixed_v6_0.6pkl_v50 改 v51_maxnodes5
1. 可調的 text width regularizer
2. max_nodes 的非 face 截斷改成 max_nodes=5 友善版本
   - 先保 1 image + 2 text + 1 svg/deco
   - 剩下名額再依 priority 與面積補齊
3. parser / dataset 預設 max_nodes 改成 5
"""
import os
import csv
import argparse
