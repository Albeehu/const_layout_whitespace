...
# - image 與 SVG 都會依照各自原始長寬比做等比例縮放
# - 支援 YOLO face detection，將 face 追加到各自 image box
# - 不需要文字輸入
# - 不需要背景圖
# - 不輸出 real poster，只輸出 layout 色塊圖與評估檔

INFER=${ROOT}/infer_official_face_v19.py
WS=${ROOT}/whitespace_metric_v10.py
OUT_ROOT=${ROOT}/final_eval/official_v21_multi_image_svgpaths_layout_only
...
# 用來讓 layout 裡的 SVG box 做等比例縮放。
# =========================
SVG_PATHS=(
  "${ROOT}/user_images/svg01.png"
  "${ROOT}/user_images/svg02.png"
)
