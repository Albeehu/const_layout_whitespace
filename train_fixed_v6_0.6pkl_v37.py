"""用 train_fixed_v6_0.6pkl_v36 改 v37
"""
import os
import argparse
import pickle
...
def main():
    ...
    for epoch in range(10000):
        for data in train_dataloader:
            ...
            if iteration % 100 == 0:
                print(f'[{iteration}] Loss_D: {loss_D.item():.4f} Loss_G: {loss_G.item():.4f} WS:{curr_lambda_ws:.3f} OV:{curr_lambda_ov:.3f} ALIGN:{curr_lambda_align:.3f} FACE:{curr_lambda_face:.3f} CONT:{curr_lambda_cont:.1f} ANCH:{curr_lambda_anchor:.1f}')
